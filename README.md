...
Worker сохраняет валидные строки и ошибки ограниченными batch-ами. Валидный отчёт
остаётся `processing` со staging до этапа атомарного применения. Создание складов,
товаров и изменение остатков ещё не реализованы.
